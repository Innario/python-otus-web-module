...
def test_main_page(browser):
    ...
    browser.find_element(By.CSS_SELECTOR, ".swiper-pagination.slideshow0.swiper-pagination-clickable.swiper-pagination-bullets")
...
def test_catalog_elements(browser):
    ...
    wait.until(EC.visibility_of_all_elements_located((By.CSS_SELECTOR, ".product-layout.product-grid.col-lg-4.col-md-4.col-sm-6.col-xs-12")))
    wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#banner0")))


def test_product_page(browser):
    browser.get("http://192.168.31.50:8081/test")
...
def test_admin_login_page(browser):
    browser.get("http://192.168.31.50:8081/admin/")
...
def test_registration_page(browser):
    browser.get("http://192.168.31.50:8081/index.php?route=account/register")
